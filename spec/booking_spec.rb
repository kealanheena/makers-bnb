...
describe Booking do
  ...
  #     expect(Booking.received(owner_username: "JDTest")[0]).to be_an_instance_of Booking
  #     expect(Booking.received(owner_username: "JDTest")[0].status).to eq "Pending  "
  #     expect(Booking.received(owner_username: "JDTest")[1].status).to eq "Pending  "
  #   end
  # end
